...
from collins.operations import Operation, OperationTypes, OperationList
...
def test__operations__reorder(opcodes: list[OperationTypes], expected: list[OperationTypes]) -> None:
    operations: list[Operation] = [
        Operation(type, 1, 0, "", "x")
        for type in opcodes
    ]
